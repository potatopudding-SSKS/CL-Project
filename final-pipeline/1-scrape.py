...
all_comments = []
video_id = ""
api_key = "AIzaSyBs4BUUbe868IZa2ymNEsbEtfoB70FCFJE"
...
def get_comments(youtube, video_id, next_view_token):
    ...
    for comment in comment_list["items"]:
        ...
        if reply_count > 0:
            ...
            replies_list = (
                youtube.comments()
                .list(part="snippet", maxResults=10, parentId=comment["id"])
                .execute()
            )
...
with open("scraped.txt", "w", encoding="utf8") as f:
